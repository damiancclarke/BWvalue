/* conjointImport.do v0.00        damiancclarke            yyyy-mm-dd:2016-12-20
----|----1----|----2----|----3----|----4----|----5----|----6----|----7----|----8
   Imports data from the DCE survey completed on MTurk, calculates geo-location, 
and merges with various state characteristics. We keep those who complete the su
rvey, and meet the applicability described in the paper (US based, > 2 minutes).
*/
...
global USG "~/investigacion/2017/BWvalue/data/geography"
